...
\begin{align*}
x_1 = \lambda_1y_1+\lambda_n, \qqaud x_2 = \lambda_2y_2 + y_n, \qquad \ldots, \qquad x_i = \lambda_iy_i+y_n, \\
x_n = y_n,
\end{align*}
Dann gilt: $B(y_1+\lambda_1y_n,\ldots,y_{n-1}+\lamda_{n-1}y_n,y_n) = P(y_1,\ldots,y_n)$ ist ein Polynom dessen Koeffizient von $y_n^d$ ist nicht null.
\end{lemma}
