...
\begin{definition}
Sei $V$ ein Vektorraum über dem Körper $K$ und $S \subset V$. Dann wird die Menge aller Linearkombinationen der $n$-Vektoren aus $S$ als \textcolor{blue}{lineare Hülle} von $S$ bezeichnet. 
\begin{align*}
...
\todo[inline]{finde homepage wo diese Graphen beschrieben sind}
\end{itemize}
