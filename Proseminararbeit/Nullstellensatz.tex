...
\begin{definition}
Eine \textcolor{blue}{Turning-Maschine} ist gegeben durch ein 7-Tupel $M =(Z,\Sigma,\Gamma,\delta,z_0,\boxempty,E)$.
\begin{itemize}
...
& Q_{uv} = \sum_{i=1}^{\alpha(G)} \left( \sum_{\substack{I \in S_i: I \cup v \notin S_{i+1} and  \\ min_v(I)=u}}  L_{i+1}x_{I\backslash u} \right), and\\ 
